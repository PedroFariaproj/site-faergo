...
const assets = {
  ...
  team: [
    ...
    { name: 'Lívia Sales', role: 'Fisioterapeuta · CREFITO 3/285938-F SP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/L%C3%ADvia%20Sales%20-%20Fisioterapeuta-j6CWlANzbcPZwmY8p7mlDRJO2GiVbk.jpeg' },
    { name: 'Silvana Melo', role: 'Educadora Física · CREF4/SP 080527-G/SP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Silvana%20Melo%20-%20Profissional%20de%20Educa%C3%A7%C3%A3o%20F%C3%ADsica%20e%20T%C3%A9cnica%20do%20Trabalho-roK0csSjhDSZgxfaRQFfHSoxdNk3I1.jpeg' },
  ],
  services: [
...
export default function Page() {
  ...
  function submitWhatsApp(e: React.FormEvent<HTMLFormElement>) {
    ...
    window.open(`https://wa.me/5511987148704?text=${encodeURIComponent(message)}`, '_blank', 'noopener,noreferrer')
  }
  ...
  return <main>
    ...
    <section className="section container contact" id="contato"><div className="contact-copy"><Eyebrow>Contato</Eyebrow><h2>Vamos avaliar sua operação.</h2><p>Envie os dados e retornamos em até um dia útil com uma proposta de diagnóstico sem custo.</p><div className="contact-links"><a href="mailto:contato@faergolaboral.com">contato@faergolaboral.com</a><a href="tel:+5511987148704">(11) 98714-8704</a><a href="https://www.instagram.com/faergolaboral" target="_blank" rel="noreferrer">@faergolaboral</a></div></div><form className="contact-form" onSubmit={submitWhatsApp}><div className="form-grid"><label>Nome *<input name="nome" required /></label><label>Empresa<input name="empresa" /></label><label>E-mail corporativo *<input name="email" type="email" required /></label><label>Nº de colaboradores<input name="colaboradores" /></label></div><label>Cenário atual<textarea name="mensagem" rows={5} /></label><button className="button button-teal" type="submit">Enviar pelo WhatsApp <ArrowUpRight /></button><small>Ao enviar, abrimos uma conversa no WhatsApp da Faergo com os seus dados preenchidos.</small></form></section>
