...
const assets = {
  ...
  team: [
    { name: 'Dra. Fabiana Paulo', role: 'Proprietária · Fisioterapeuta', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fabiana%20paulo%20-%20dona%20da%20empresa-sdo69dx7enSgpMZZZAIrt9E937mu1p.jpeg' },
...
export default function Page() {
  ...
  return <main>
    ...
    <section className="stats container-wide"><div><strong>12 anos</strong><span>em saúde ocupacional</span></div><div><strong>40+</strong><span>empresas atendidas</span></div><div><strong>6.000</strong><span>colaboradores em programa</span></div><div><strong>NR-1 e NR-17</strong><span>conformidade como base</span></div></section>
